...
UIWidgetHeaderBar <- function()
{
  ...
  split_layout(style = "display: flex;      /* Set up flexbox to use 'justify-content: space-between' to enable free space between columns without specifying column width */
               ...
               split_layout(style = "justify-self: end;
                            ...
                            action_button("LoginButton",
                                          label = "Login"),

                            # Logout Button
                            action_button("LogoutButton",
                                          label = "Logout")))
